...
def extract_all_zips(directory, temp_directory):
...
def main():
    ...
    # Cria um diretório temporário para a extração dos arquivos ZIP
    with tempfile.TemporaryDirectory() as temp_directory:
        # Step 1: Extract all ZIP files into the temporary directory
        extract_all_zips(current_directory, temp_directory)
